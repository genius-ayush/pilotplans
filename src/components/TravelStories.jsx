    ...
    <div className='flex flex-col items-center py-16 bg-gray-50'>
        ...
        <div className='flex flex-col lg:flex-row justify-around  px-8 w-3/4'>
            <div className='p-6  mb-8 lg:mb-0 w-full lg:w-1/3 mx-2'>
                <img src="./TravelStories/img1.jpg" alt="" className='w-full h-64 object-cover rounded-xl mb-4'/>
            ...
            <div className='p-6 mb-8 lg:mb-0 w-full lg:w-1/3 mx-2'>
                <img src="./TravelStories/img2.jpg" alt="" className='w-full h-64  rounded-xl mb-4'/>
            ...
            <div className='p-6 mb-8 lg:mb-0 w-full lg:w-1/3 mx-2'>
                <img src="./TravelStories/img3.jpeg" alt="" className='w-full h-64 object-cover rounded-xl mb-4' />
