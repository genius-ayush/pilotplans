    ...
    <div>
      <Slider {...settings}>
        <div className="flex-col items-center justify-center">
          <img src="./TripPlanImages/image1.webp" className="h-80" alt="" />
          <div className="ml-20 mt-5">Add daily activities</div>
        </div>
        <div className="">
          <img src="./TripPlanImages/image2.webp" className="h-80" alt="" />
          <div className="ml-12 mt-5">Create beautiful inineraries</div>
        </div>
        <div className="">
          <img src="./TripPlanImages/image3.webp" className="h-80" alt="" />
          <div className="ml-8 mt-5">Easily plan days and routes in one view</div>
        </div>
        <div className="">
          <img src="./TripPlanImages/image4.webp" className="h-80" alt="" />
          <div className="ml-16 mt-5">Get Travel eVisas in 3 clicks</div>
        </div>
        <div className="">
          <img src="./TripPlanImages/image5.webp" className="h-80" alt="" />
