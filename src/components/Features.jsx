    ...
    <div className="flex flex-col items-center justify-center  py-16 bg-gray-50">
      ...
      <div className="flex flex-col lg:flex-row justify-around w-3/4 px-8">
        <div className="bg-orange-100 p-6 rounded-md shadow-md mb-8 lg:mb-0 w-full lg:w-1/3 mx-2">
          ...
          <img src="../public/Features/img1.png" alt="Discover" className="w-full h-48 object-cover rounded-md mb-4" />
        ...
        <div className="bg-orange-100 p-6 rounded-md shadow-md mb-8 lg:mb-0 w-full lg:w-1/3 mx-2">
          <img src="../public/Features/img2.png" alt="Quick Start" className="w-full h-48 object-cover rounded-md mb-4" />
        ...
        <div className="bg-orange-100 p-6 rounded-md shadow-md mb-8 lg:mb-0 w-full lg:w-1/3 mx-2">
          <img src="../public/Features/img3.png" alt="Stays" className="w-full h-48 object-cover rounded-md mb-4" />
